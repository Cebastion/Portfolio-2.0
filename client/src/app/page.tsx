        ...
        <div className="mt-20 pb-3 flex justify-between max-[945px]:flex-col max-[945px]:w-[80%] max-[945px]:mx-auto">
          ...
          <form onSubmit={SendEmail} id='gmail-form' className="flex flex-col gap-6 items-start max-[945px]:mt-5">
            <div className="flex flex-col gap-1 max-[700px]:w-full">
              ...
              <input value={Form.name} onChange={handleInputChange} name='Name' type="text" className='px-4 py-3 w-[600px] h-14 bg-[#1a1a1a] font-manrope font-normal text-base text-white max-[700px]:w-full' required />
            </div>
            <div className="flex flex-col gap-1 max-[700px]:w-full">
              <label htmlFor="Email" className='font-manrope font-medium text-base text-white'>Email</label>
              <input value={Form.email} onChange={handleInputChange} name='Email' type="email" className='px-4 py-3 w-[600px] h-14 bg-[#1a1a1a] font-manrope font-normal text-base text-white max-[700px]:w-full' required />
            </div>
            <div className="flex flex-col gap-1 max-[700px]:w-full">
              <label htmlFor="Subject" className='font-manrope font-medium text-base text-white'>Subject</label>
              <input value={Form.subject} onChange={handleInputChange} name='Subject' type="text" className='px-4 py-3 w-[600px] h-14 bg-[#1a1a1a] font-manrope font-normal text-base text-white max-[700px]:w-full' required />
            </div>
            <div className="flex flex-col gap-1 max-[700px]:w-full">
              <label htmlFor="Message" className='font-manrope font-medium text-base text-white'>Message</label>
              <textarea value={Form.message} onChange={handleInputChange} name="Message" className='px-4 py-3 w-[600px] h-40 bg-[#1a1a1a] font-manrope font-normal text-base text-white resize-none max-[700px]:w-full' required />
            </div>
